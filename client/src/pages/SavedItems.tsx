...
function Gate({ children }: GateProps) {
  ...
  if (!user) return <section className="status-page"><UserRound size={34} /><h1>Sign in to see saved items.</h1><p>Your bookmarks are private to your BeatBox account.</p><Link className="button" href="/auth">Sign in</Link></section>;
  return <>{children}</>;
}
